...
pub fn x(self: Vector3) f32 {
	return self.data[0];
}

pub fn y(self: Vector3) f32 {
	return self.data[1];
}

pub fn z(self: Vector3) f32 {
	return self.data[2];
}
...
pub fn opposite(self: Vector3) Vector3 {
	const temp: Vector3 = .{
		.data = -self.data
	};
	return temp;
...
pub fn magnitudeSquared(self: Vector3) f32 {
	return (
...
pub fn randomUnitVector(random: std.Random) Vector3 {
...
pub fn isCloseToZero(v: Vector3) bool {
	const s = 1e-8;
